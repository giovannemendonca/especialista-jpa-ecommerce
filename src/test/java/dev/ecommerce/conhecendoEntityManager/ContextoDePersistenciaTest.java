...
public class ContextoDePersistenciaTest  extends EntityManagerTest {
    ...
    public void usarContextoPersistencia(){
        ...
        produto2.setPreco(BigDecimal.valueOf(10.0));
        ...
        produto3.setPreco(BigDecimal.valueOf(10.0));
        produto3.setDescricao("Boa caneca para chá");
        produto3 = entityManager.merge(produto3);

        entityManager.flush();

        produto3.setDescricao("Alterar descrição"); // não é necessário chamar o merge novamente, pois o objeto já está sendo gerenciado pelo JPA
